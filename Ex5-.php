...
<html lang="en">
  ...
  <body>
    <div class="container">
        <h1 class="pt-3">โปรแกรมเครื่องคำนวณหาค่าดัชนีมวลกาย (BMI)</h1>
        <form class="row pt-3 g-3" method="GET" action="Ex5-.php">
            <div class="col-auto">
              <label for="mark" class="visually-hidden">น้ำหนัก</label>
              <input type="text"  class="form-control"  placeholder="น้ำหนัก"
              id="weight" name="weight" value="">
            </div>
            <div class="col-auto">
              <label for="mark" class="visually-hidden">ส่วนสูง</label>
              <input type="text"  class="form-control"  placeholder="ส่วนสูง"
              id="height" name="height" value="">
            </div>
            
            <div class="col-auto">
              <button type="submit" value="submit" name="submit" class="btn btn-primary mb-3">คำนวน</button>
            </div>
          </form>
    </div>
